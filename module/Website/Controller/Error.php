...
class Error extends ControllerAbstract
{
    ...
    {
        $this->_model->add(['messageH1' => 'Application Error!', 'messageB' => 'Route not Found!']);
        $this->_model->assignViewVars('error');
    }

    public function nocontroller()
    {
        $this->_model->add(['messageH1' => 'Application Error!', 'messageB' => 'Controller not Found!']);
        $this->_model->assignViewVars('error');
    }

    public function noaction()
    {
        $this->_model->add(['messageH1' => 'Application Error!', 'messageB' => 'Action-method not Found!']);
        $this->_model->assignViewVars('error');
    }

    public function internal()
    {
        $this->_model->add(['messageH1' => 'Application Error!', 'messageB' => 'An internal error occurred!']);
        $this->_model->assignViewVars('error');
    }
}
